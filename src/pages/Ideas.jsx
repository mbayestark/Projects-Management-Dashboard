    ...
    <div className="bg-card border border-border p-4 mb-3">
      <div className="flex justify-between items-start gap-2 mb-2">
        <button
          ...
          className="text-text font-semibold text-sm text-left flex-1"
        >
          {idea.title}
        </button>
        <select
        ...
        <div className="mt-3">
          {editingBody ? (
            ...
            <div
              ...
              className="text-sm text-muted cursor-pointer min-h-[2rem]"
            >
          ...
          {showPromote && (
            <div className="mt-3 border border-border p-3 flex flex-col gap-2">
              <input
                ...
                className="bg-transparent border-b border-border text-sm text-text outline-none py-1"
              />
              <select
                value={promoteTier}
              ...
              <div className="flex gap-2">
                ...
                <button type="button" onClick={() => setShowPromote(false)} className="text-sm text-muted">
                  Cancel
                </button>
              </div>
            </div>
      ...
      {adding && (
        <div className="bg-card border border-border p-4 mb-4">
          <input
            ...
            className="w-full bg-transparent border-b border-border text-sm text-text outline-none py-1 mb-2"
            autoFocus
          />
          <textarea
            value={form.body}
            ...
            rows={2}
            className="w-full bg-transparent border border-border p-2 text-sm text-text outline-none resize-y mb-2"
          />
          <select
            value={form.category}
